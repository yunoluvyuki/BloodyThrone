...
const CREATURES = [
  ...
  {id:'corpse_crawler',name:'CORPSE CRAWLER',
    hp:80,atk:7,mnd:0.7,mxd:1.2,spd:3000,rgn:1,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,blk:0,bld:0,ctr:0,
  ...
  {id:'blighted_husk',name:'BLIGHTED HUSK',
    ...
    rewards:{hp:2,atk:2,old:20,bronze:1},
    vicReq:5},
  {id:'soot_fiend',name:'SOOT FIEND',
    hp:80,atk:12,mnd:0.7,mxd:1.2,spd:2500,rgn:0,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,blk:0,bld:0,ctr:0,
  ...
  {id:'hollow_eye',name:'HOLLOW EYE',
    hp:280,atk:22,mnd:1,mxd:1.4,spd:3000,rgn:0,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:5,hp:20,old:200},
    vicReq:5},
  {id:'dungeon_tick',name:'DUNGEON TICK',
    hp:333,atk:33,mnd:1,mxd:1.4,spd:3333,rgn:3,ddc:0,crc:0,crd:0,arm:3.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:3,hp:33,arm:3,old:333},
    vicReq:5},
...
const SHOP_ITEMS = [
  ...
  {id:'Upgrade_MND', name:'MND Upgrade',  desc:'Increase minimal damage',         effect:'MND +1%',   cost:{old:20}, statBonus:{mnd:0.01}, maxOwned:100},
  {id:'Upgrade_MXD', name:'MXD Upgrade',  desc:'Increase maximum damage',         effect:'MXD +1%',   cost:{old:20}, statBonus:{mxd:0.01}, maxOwned:100},
  {id:'Upgrade_SPD', name:'SPD Upgrade',  desc:'Reduce turn time (faster)',       effect:'SPD -10ms', cost:{old:10}, statBonus:{spd:-10}, maxOwned:100},
  {id:'Upgrade_RGN', name:'RGN Upgrade',  desc:'Increase health regeneration',    effect:'RGN +1%',   cost:{old:10}, statBonus:{rgn:0.01}, isPct:true, maxOwned:100},
  {id:'Upgrade_DDC', name:'DDC Upgrade',  desc:'Increase dodge chance',           effect:'DDC +1%',   cost:{old:20}, statBonus:{ddc:0.01}, maxOwned:100},
  {id:'Upgrade_CRC', name:'CRC Upgrade',  desc:'Increase critical rate',          effect:'CRC +2%',   cost:{old:20}, statBonus:{crc:0.01}, maxOwned:100},
  {id:'Upgrade_CRD', name:'CRD Upgrade',  desc:'Increase critical damage',        effect:'CRD +10%',  cost:{old:10}, statBonus:{crd:0.1}, maxOwned:100},
  {id:'Upgrade_ARM', name:'ARM Upgrade',  desc:'Increase armor',                  effect:'ARM +1%',   cost:{old:1}, statBonus:{arm:0.01}, isPct:true, maxOwned:100},
  {id:'Upgrade_MTH', name:'MTH Upgrade',  desc:'Increase multi hit chance',       effect:'MTH +1%',   cost:{old:50}, statBonus:{mth:0.01}, maxOwned:100},
  {id:'Upgrade_ACC', name:'ACC Upgrade',  desc:'Increase accuracy',               effect:'ACC +1%',   cost:{old:10}, statBonus:{acc:0.01}, maxOwned:100},
  {id:'Upgrade_BLK', name:'BLK Upgrade',  desc:'Increase block chance',           effect:'BLK +1%',   cost:{old:10}, statBonus:{blk:0.01}, maxOwned:100},
  {id:'Upgrade_BLD', name:'BLD Upgrade',  desc:'Increase block damage reduction', effect:'BLD +1%',   cost:{old:20}, statBonus:{bld:0.01}, isPct:true, maxOwned:100},
  {id:'Upgrade_CTR', name:'CTR Upgrade',  desc:'Increase counter rate',           effect:'CTR +1%',   cost:{old:50}, statBonus:{ctr:0.01}, maxOwned:100},
];