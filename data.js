...
const CREATURES = [
  {id:'hollow_wretch',name:'HOLLOW WRETCH',
    hp:5,atk:2,mnd:0.7,mxd:1.2,spd:3000,rgn:0,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1,old:1},
    vicReq:5,
    img:'attached_assets/img/creature/1hollow_wretch.png'},
  {id:'plague_hound',name:'PLAGUE HOUND',
    hp:10,atk:3,mnd:0.7,mxd:1.2,spd:3000,rgn:0,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:5,old:2},
    vicReq:5,
    img:'attached_assets/img/creature/2plague_hound.png'},
  {id:'ashwalker',name:'ASHWALKER',
    hp:15,atk:4,mnd:0.7,mxd:1.2,spd:3000,rgn:0,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{arm:0.3,old:1},
    vicReq:5,
    img:'attached_assets/img/creature/3ashwalker.png'},
  {id:'bonepicker',name:'BONEPICKER',
    hp:25,atk:4,mnd:0.7,mxd:1.2,spd:2500,rgn:0,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2,hp:6,old:2},
    vicReq:5},
  {id:'grave_rat',name:'GRAVE RAT',
    hp:20,atk:5,mnd:0.7,mxd:1.2,spd:1500,rgn:0,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{spd:-10,atk:1,old:5},
    vicReq:5},
  {id:'mudborn',name:'MUDBORN',
    hp:50,atk:10,mnd:0.7,mxd:1.2,spd:4000,rgn:0,ddc:0,crc:0,crd:0,arm:2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2,hp:12,old:5},
    vicReq:5},
  {id:'corpse_crawler',name:'CORPSE CRAWLER',
    hp:80,atk:5,mnd:0.7,mxd:1.2,spd:3000,rgn:0,ddc:0,crc:0,crd:0,arm:1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{arm:0.5,old:5},
    vicReq:5},
  {id:'rotting_serf',name:'ROTTING SERF',
    hp:60,atk:10,mnd:0.7,mxd:1.2,spd:2000,rgn:1,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{rgn:0.5,old:10},
    vicReq:5},
  {id:'blighted_husk',name:'BLIGHTED HUSK',
    hp:100,atk:6,mnd:0.7,mxd:1.2,spd:1500,rgn:1,ddc:0,crc:0,crd:0,arm:2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:2,atk:2,old:20,silver:1},
    vicReq:5},
  {id:'soot_fiend',name:'SOOT FIEND',
    hp:50,atk:12,mnd:0.7,mxd:1.2,spd:2500,rgn:0,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:5,old:50},
    vicReq:5},
  {id:'wretched_thrall',name:'WRETCHED THRALL',
    hp:120,atk:15,mnd:0.7,mxd:1.2,spd:3000,rgn:0,ddc:0,crc:0,crd:0,arm:5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:5,old:30},
    vicReq:5},
  {id:'festering_vagrant',name:'FESTERING VAGRANT',
    hp:200,atk:20,mnd:0.7,mxd:1.2,spd:5000,rgn:0,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:10,atk:5,old:100},
    vicReq:5},
  {id:'hollow_eye',name:'HOLLOW EYE',
    hp:1100,atk:15,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.17,old:0.37},
    vicReq:5},
  {id:'dungeon_tick',name:'DUNGEON TICK',
    hp:1150,atk:17,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.4,hp:0.65},
    vicReq:5},
  {id:'gravel_ghoul',name:'GRAVEL GHOUL',
    hp:1200,atk:18,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.18,old:0.42},
    vicReq:5},
  {id:'bile_spawn',name:'BILE SPAWN',
    hp:1250,atk:19,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:0.7,old:0.44},
    vicReq:5},
  {id:'mossrot',name:'MOSSROT',
    hp:1300,atk:21,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.19,old:0.46},
    vicReq:5},
  {id:'scab_crawler',name:'SCAB CRAWLER',
    hp:1350,atk:22,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.48,atk:0.17},
    vicReq:5},
  {id:'charnel_fly',name:'CHARNEL FLY',
    hp:1400,atk:23,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:0.75,old:0.5},
    vicReq:5},
  {id:'skinless_beggar',name:'SKINLESS BEGGAR',
    hp:1450,atk:25,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.2,old:0.52},
    vicReq:5},
  {id:'weeping_hollow',name:'WEEPING HOLLOW',
    hp:1500,atk:26,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.54,hp:0.8},
    vicReq:5},
  {id:'maggot_knight',name:'MAGGOT KNIGHT',
    hp:1550,atk:27,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.21,old:0.56},
    vicReq:5},
  {id:'cinder_wretch',name:'CINDER WRETCH',
    hp:1600,atk:29,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:0.85,old:0.58},
    vicReq:5},
  {id:'sallow_shade',name:'SALLOW SHADE',
    hp:1650,atk:30,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.22,old:0.6},
    vicReq:5},
  {id:'mud_ghoul',name:'MUD GHOUL',
    hp:1700,atk:32,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.62,hp:0.9},
    vicReq:5},
  {id:'bonegnaw',name:'BONEGNAW',
    hp:1750,atk:33,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.23,old:0.64},
    vicReq:5},
  {id:'ashen_tramp',name:'ASHEN TRAMP',
    hp:1800,atk:34,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:0.95,old:0.66},
    vicReq:5},
  {id:'foul_creeper',name:'FOUL CREEPER',
    hp:1850,atk:36,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.24,old:0.68},
    vicReq:5},
  {id:'plague_bearer',name:'PLAGUE BEARER',
    hp:1900,atk:37,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.7,hp:1.0},
    vicReq:5},
  {id:'tallow_shade',name:'TALLOW SHADE',
    hp:1950,atk:39,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.25,old:0.72},
    vicReq:5},
  {id:'rot_worm',name:'ROT WORM',
    hp:2000,atk:40,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.05,old:0.74},
    vicReq:5},
  {id:'filth_shambler',name:'FILTH SHAMBLER',
    hp:2050,atk:42,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.26,old:0.76},
    vicReq:5},
  {id:'corpse_leech',name:'CORPSE LEECH',
    hp:2100,atk:43,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.78,hp:1.1},
    vicReq:5},
  {id:'bleached_lurker',name:'BLEACHED LURKER',
    hp:2150,atk:45,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.27,old:0.8},
    vicReq:5},
  {id:'grave_digger',name:'GRAVE DIGGER',
    hp:2200,atk:46,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.15,old:0.82},
    vicReq:5},
  {id:'putrid_wisp',name:'PUTRID WISP',
    hp:2250,atk:48,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.28,old:0.84},
    vicReq:5},
  {id:'wailing_husk',name:'WAILING HUSK',
    hp:2300,atk:49,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.86,hp:1.2},
    vicReq:5},
  {id:'dustbone',name:'DUSTBONE',
    hp:2350,atk:51,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:2.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.29,old:0.88},
    vicReq:5},
  {id:'sludge_spawn',name:'SLUDGE SPAWN',
    hp:2400,atk:52,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.25,old:0.9},
    vicReq:5},
  {id:'tomb_rat',name:'TOMB RAT',
    hp:2450,atk:54,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.3,old:0.92},
    vicReq:5},
  {id:'cracked_skull',name:'CRACKED SKULL',
    hp:2500,atk:55,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.94,hp:1.3},
    vicReq:5},
  {id:'pale_shambler',name:'PALE SHAMBLER',
    hp:2550,atk:57,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.31,old:0.96},
    vicReq:5},
  {id:'rotfen_cur',name:'ROTFEN CUR',
    hp:2600,atk:58,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.35,old:0.98},
    vicReq:5},
  {id:'ash_crawler',name:'ASH CRAWLER',
    hp:2650,atk:60,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.32,old:1.0},
    vicReq:5},
  {id:'bonedust_wretch',name:'BONEDUST WRETCH',
    hp:2700,atk:61,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1.02,hp:1.4},
    vicReq:5},
  {id:'famine_shade',name:'FAMINE SHADE',
    hp:2750,atk:63,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.33,old:1.04},
    vicReq:5},
  {id:'cobweb_ghoul',name:'COBWEB GHOUL',
    hp:2800,atk:64,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.45,old:1.06},
    vicReq:5},
  {id:'soot_crawler',name:'SOOT CRAWLER',
    hp:2850,atk:66,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.34,old:1.08},
    vicReq:5},
  {id:'charred_beggar',name:'CHARRED BEGGAR',
    hp:2900,atk:67,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1.1,hp:1.5},
    vicReq:5},
  {id:'hollow_pup',name:'HOLLOW PUP',
    hp:2950,atk:69,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.35,old:1.12},
    vicReq:5},
  {id:'mire_fiend',name:'MIRE FIEND',
    hp:3000,atk:70,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.55,old:1.14},
    vicReq:5},
  {id:'ditch_ghoul',name:'DITCH GHOUL',
    hp:3050,atk:72,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.36,old:1.16},
    vicReq:5},
  {id:'scorch_wretch',name:'SCORCH WRETCH',
    hp:3100,atk:73,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1.18,hp:1.6},
    vicReq:5},
  {id:'festering_hound',name:'FESTERING HOUND',
    hp:3150,atk:75,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.37,old:1.2},
    vicReq:5},
  {id:'gutter_shade',name:'GUTTER SHADE',
    hp:3200,atk:76,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.65,old:1.22},
    vicReq:5},
  {id:'bog_lurker',name:'BOG LURKER',
    hp:3250,atk:78,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.38,old:1.24},
    vicReq:5},
  {id:'cinder_rat',name:'CINDER RAT',
    hp:3300,atk:79,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1.26,hp:1.7},
    vicReq:5},
  {id:'dried_husk',name:'DRIED HUSK',
    hp:3350,atk:81,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:3.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.39,old:1.28},
    vicReq:5},
  {id:'brackish_spawn',name:'BRACKISH SPAWN',
    hp:3400,atk:82,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.75,old:1.3},
    vicReq:5},
  {id:'sunken_wretch',name:'SUNKEN WRETCH',
    hp:3450,atk:84,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.4,old:1.32},
    vicReq:5},
  {id:'tallow_ghoul',name:'TALLOW GHOUL',
    hp:3500,atk:85,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1.34,hp:1.8},
    vicReq:5},
  {id:'blister_fiend',name:'BLISTER FIEND',
    hp:3550,atk:87,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.41,old:1.36},
    vicReq:5},
  {id:'gravel_rat',name:'GRAVEL RAT',
    hp:3600,atk:88,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.85,old:1.38},
    vicReq:5},
  {id:'mudwater_shade',name:'MUDWATER SHADE',
    hp:3650,atk:90,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.42,old:1.4},
    vicReq:5},
  {id:'pale_crawler',name:'PALE CRAWLER',
    hp:3700,atk:91,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1.42,hp:1.9},
    vicReq:5},
  {id:'crumbling_thrall',name:'CRUMBLING THRALL',
    hp:3750,atk:93,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.43,old:1.44},
    vicReq:5},
  {id:'fen_ghoul',name:'FEN GHOUL',
    hp:3800,atk:94,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:1.95,old:1.46},
    vicReq:5},
  {id:'ashen_cur',name:'ASHEN CUR',
    hp:3850,atk:96,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.44,old:1.48},
    vicReq:5},
  {id:'charnel_rat',name:'CHARNEL RAT',
    hp:3900,atk:97,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1.5,hp:2.0},
    vicReq:5},
  {id:'bone_fly',name:'BONE FLY',
    hp:3950,atk:99,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.45,old:1.52},
    vicReq:5},
  {id:'sour_shade',name:'SOUR SHADE',
    hp:4000,atk:100,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:2.05,old:1.54},
    vicReq:5},
  {id:'rot_pup',name:'ROT PUP',
    hp:4100,atk:102,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.46,old:1.56},
    vicReq:5},
  {id:'crypt_tick',name:'CRYPT TICK',
    hp:4200,atk:103,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1.58,hp:2.1},
    vicReq:5},
  {id:'damp_husk',name:'DAMP HUSK',
    hp:4300,atk:105,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.47,old:1.6},
    vicReq:5},
  {id:'scab_fiend',name:'SCAB FIEND',
    hp:4400,atk:106,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:2.15,old:1.62},
    vicReq:5},
  {id:'hollow_stray',name:'HOLLOW STRAY',
    hp:4500,atk:108,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.48,old:1.64},
    vicReq:5},
  {id:'cobweb_wretch',name:'COBWEB WRETCH',
    hp:4600,atk:109,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1.66,hp:2.2},
    vicReq:5},
  {id:'silt_shambler',name:'SILT SHAMBLER',
    hp:4800,atk:111,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:4.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.49,old:1.68},
    vicReq:5},
  {id:'dusty_ghoul',name:'DUSTY GHOUL',
    hp:5000,atk:112,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:5.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:2.25,old:1.7},
    vicReq:5},
  {id:'hollow_shambler',name:'HOLLOW SHAMBLER',
    hp:5200,atk:114,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:5.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.5,old:1.72},
    vicReq:5},
  {id:'cursed_knight',name:'CURSED KNIGHT',
    hp:5500,atk:120,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:5.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.9,old:2.0,arm:0.05},
    vicReq:5},
  {id:'plague_archer',name:'PLAGUE ARCHER',
    hp:5800,atk:130,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:5.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:2.2,bronze:0.5},
    vicReq:5},
  {id:'blighted_halberdier',name:'BLIGHTED HALBERDIER',
    hp:6100,atk:140,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:6.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.0,old:2.4,arm:0.06},
    vicReq:5},
  {id:'hollow_sergeant',name:'HOLLOW SERGEANT',
    hp:6400,atk:150,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:6.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:2.6,bronze:0.8},
    vicReq:5},
  {id:'rot_shaman',name:'ROT SHAMAN',
    hp:6700,atk:160,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:6.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.1,old:2.8,arm:0.07},
    vicReq:5},
  {id:'ashbound_soldier',name:'ASHBOUND SOLDIER',
    hp:7000,atk:170,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:7.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:3.0,bronze:1.0},
    vicReq:5},
  {id:'bonecage_warrior',name:'BONECAGE WARRIOR',
    hp:7300,atk:180,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:7.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.2,old:3.2,arm:0.08},
    vicReq:5},
  {id:'gravewarden',name:'GRAVEWARDEN',
    hp:7600,atk:190,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:7.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:3.4,bronze:1.2},
    vicReq:5},
  {id:'fetid_executioner',name:'FETID EXECUTIONER',
    hp:7900,atk:200,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:7.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.3,old:3.6,arm:0.09},
    vicReq:5},
  {id:'rusted_templar',name:'RUSTED TEMPLAR',
    hp:8200,atk:210,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:8.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:3.8,bronze:1.4},
    vicReq:5},
  {id:'ironblight_monk',name:'IRONBLIGHT MONK',
    hp:8500,atk:221,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:8.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.4,old:4.0,arm:0.1},
    vicReq:5},
  {id:'crypt_sentinel',name:'CRYPT SENTINEL',
    hp:8800,atk:231,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:8.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:4.2,bronze:1.6},
    vicReq:5},
  {id:'void_hound',name:'VOID HOUND',
    hp:9100,atk:241,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:9.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.5,old:4.4,arm:0.11},
    vicReq:5},
  {id:'soulless_pikeman',name:'SOULLESS PIKEMAN',
    hp:9400,atk:251,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:9.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:4.6,bronze:1.8},
    vicReq:5},
  {id:'charnel_blade',name:'CHARNEL BLADE',
    hp:9700,atk:261,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:9.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.6,old:4.8,arm:0.12},
    vicReq:5},
  {id:'flayed_scout',name:'FLAYED SCOUT',
    hp:10000,atk:271,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:10.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:5.0,bronze:2.0},
    vicReq:5},
  {id:'worm_priest',name:'WORM PRIEST',
    hp:10300,atk:282,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:10.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.7,old:5.2,arm:0.13},
    vicReq:5},
  {id:'ashgrave_guardian',name:'ASHGRAVE GUARDIAN',
    hp:10600,atk:292,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:10.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:5.4,bronze:2.2},
    vicReq:5},
  {id:'mournful_specter',name:'MOURNFUL SPECTER',
    hp:10900,atk:302,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:11.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.8,old:5.6,arm:0.14},
    vicReq:5},
  {id:'marrow_stalker',name:'MARROW STALKER',
    hp:11200,atk:312,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:11.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:5.8,bronze:2.4},
    vicReq:5},
  {id:'duskblade_revenant',name:'DUSKBLADE REVENANT',
    hp:11500,atk:322,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:11.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1.9,old:6.0,arm:0.15},
    vicReq:5},
  {id:'smoldering_footman',name:'SMOLDERING FOOTMAN',
    hp:11800,atk:333,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:12.0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:6.2,bronze:2.6},
    vicReq:5},
  {id:'blight_ranger',name:'BLIGHT RANGER',
    hp:12100,atk:343,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:12.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2.0,old:6.4,arm:0.16},
    vicReq:5},
  {id:'accursed_legionnaire',name:'ACCURSED LEGIONNAIRE',
    hp:12400,atk:353,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:12.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:6.6,bronze:2.8},
    vicReq:5},
  {id:'dead_eye_marksman',name:'DEAD EYE MARKSMAN',
    hp:12700,atk:363,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:12.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2.1,old:6.8,arm:0.17},
    vicReq:5},
  {id:'tomb_warden',name:'TOMB WARDEN',
    hp:13000,atk:373,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:13.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:7.0,bronze:3.0},
    vicReq:5},
  {id:'sable_crow',name:'SABLE CROW',
    hp:13300,atk:383,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:13.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2.2,old:7.2,arm:0.18},
    vicReq:5},
  {id:'ironrot_berserker',name:'IRONROT BERSERKER',
    hp:13600,atk:394,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:13.9,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:7.4,bronze:3.2},
    vicReq:5},
  {id:'plague_monk',name:'PLAGUE MONK',
    hp:13900,atk:404,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:14.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2.3,old:7.6,arm:0.19},
    vicReq:5},
  {id:'blighted_squire',name:'BLIGHTED SQUIRE',
    hp:14200,atk:414,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:14.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:7.8,bronze:3.4},
    vicReq:5},
  {id:'hollow_cavalier',name:'HOLLOW CAVALIER',
    hp:14500,atk:424,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:14.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2.4,old:8.0,arm:0.2},
    vicReq:5},
  {id:'gravebound_duelist',name:'GRAVEBOUND DUELIST',
    hp:14700,atk:434,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:15.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:8.2,bronze:3.6},
    vicReq:5},
  {id:'withered_inquisitor',name:'WITHERED INQUISITOR',
    hp:15000,atk:445,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:15.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2.5,old:8.4,arm:0.21},
    vicReq:5},
  {id:'shroud_knight',name:'SHROUD KNIGHT',
    hp:15200,atk:455,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:15.8,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:8.6,bronze:3.8},
    vicReq:5},
  {id:'bone_arbalist',name:'BONE ARBALIST',
    hp:15500,atk:465,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:16.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2.6,old:8.8,arm:0.22},
    vicReq:5},
  {id:'ash_zealot',name:'ASH ZEALOT',
    hp:15700,atk:475,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:16.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:9.0,bronze:4.0},
    vicReq:5},
  {id:'saltblood_soldier',name:'SALTBLOOD SOLDIER',
    hp:16000,atk:485,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:16.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2.7,old:9.2,arm:0.23},
    vicReq:5},
  {id:'dread_footman',name:'DREAD FOOTMAN',
    hp:16300,atk:496,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:17.1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:9.4,bronze:4.2},
    vicReq:5},
  {id:'ruinborn_warden',name:'RUINBORN WARDEN',
    hp:16600,atk:506,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:17.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:2.8,old:9.6,arm:0.24},
    vicReq:5},
  {id:'forsaken_outrider',name:'FORSAKEN OUTRIDER',
    hp:16900,atk:516,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:17.7,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:9.8,bronze:4.4},
    vicReq:5},
  {id:'bonegrinder',name:'BONEGRINDER',
    hp:22000,atk:800,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:35,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:5.0,arm:1.2,old:100},
    vicReq:5},
  {id:'voidborn_witch',name:'VOIDBORN WITCH',
    hp:24000,atk:850,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:36.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:120,bronze:20,crc:0.08},
    vicReq:5},
  {id:'weeping_shade',name:'WEEPING SHADE',
    hp:26000,atk:900,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:38,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:5.5,old:140,arm:1.5},
    vicReq:5},
  {id:'soul_eater',name:'SOUL EATER',
    hp:28000,atk:950,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:39.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:160,bronze:30,silver:5},
    vicReq:5},
  {id:'dread_colossus',name:'DREAD COLOSSUS',
    hp:30000,atk:1000,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:41,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:6.0,arm:2.0,old:180},
    vicReq:5},
  {id:'flesh_sculptor',name:'FLESH SCULPTOR',
    hp:32000,atk:1050,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:42.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:200,bronze:40,silver:7},
    vicReq:5},
  {id:'blighted_hydra',name:'BLIGHTED HYDRA',
    hp:34000,atk:1100,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:44,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:6.5,arm:2.5,old:220},
    vicReq:5},
  {id:'pale_stalker',name:'PALE STALKER',
    hp:36000,atk:1150,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:45.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:240,bronze:50,crc:0.1},
    vicReq:5},
  {id:'abyssal_hound',name:'ABYSSAL HOUND',
    hp:38000,atk:1200,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:47,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:7.0,arm:3.0,old:260},
    vicReq:5},
  {id:'marrow_golem',name:'MARROW GOLEM',
    hp:40000,atk:1250,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:48.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:280,bronze:60,silver:10},
    vicReq:5},
  {id:'gravemind_thrall',name:'GRAVEMIND THRALL',
    hp:42000,atk:1300,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:50,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:7.5,arm:3.5,old:300},
    vicReq:5},
  {id:'soulrend_fiend',name:'SOULREND FIEND',
    hp:44000,atk:1355,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:51.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:320,bronze:70,silver:12},
    vicReq:5},
  {id:'crypt_behemoth',name:'CRYPT BEHEMOTH',
    hp:46000,atk:1410,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:53,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:8.0,arm:4.0,old:340},
    vicReq:5},
  {id:'ashen_revenant',name:'ASHEN REVENANT',
    hp:48000,atk:1465,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:54.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:360,bronze:80,silver:14},
    vicReq:5},
  {id:'hollow_titan',name:'HOLLOW TITAN',
    hp:50000,atk:1520,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:56,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:8.5,arm:4.5,old:380},
    vicReq:5},
  {id:'plague_chimera',name:'PLAGUE CHIMERA',
    hp:52000,atk:1575,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:57.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:400,bronze:90,silver:16},
    vicReq:5},
  {id:'bone_leviathan',name:'BONE LEVIATHAN',
    hp:54000,atk:1630,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:59,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:9.0,arm:5.0,old:420},
    vicReq:5},
  {id:'wretched_oracle',name:'WRETCHED ORACLE',
    hp:56000,atk:1685,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:60.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:440,bronze:100,silver:18},
    vicReq:5},
  {id:'dusk_warden',name:'DUSK WARDEN',
    hp:58000,atk:1740,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:62,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:9.5,arm:5.5,old:460},
    vicReq:5},
  {id:'voidtouched_wraith',name:'VOIDTOUCHED WRAITH',
    hp:60000,atk:1795,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:63.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:480,bronze:110,silver:20},
    vicReq:5},
  {id:'ironblight_giant',name:'IRONBLIGHT GIANT',
    hp:62000,atk:1850,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:65,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:10.0,arm:6.0,old:500},
    vicReq:5},
  {id:'charnel_hydra',name:'CHARNEL HYDRA',
    hp:64000,atk:1905,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:66.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:520,bronze:120,silver:22},
    vicReq:5},
  {id:'nightmare_shade',name:'NIGHTMARE SHADE',
    hp:66000,atk:1960,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:68,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:10.5,arm:6.5,old:540},
    vicReq:5},
  {id:'graveworm_matron',name:'GRAVEWORM MATRON',
    hp:68000,atk:2015,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:69.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:560,bronze:130,silver:24},
    vicReq:5},
  {id:'soul_harvester',name:'SOUL HARVESTER',
    hp:70000,atk:2070,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:71,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:11.0,arm:7.0,old:580},
    vicReq:5},
  {id:'blighted_cyclops',name:'BLIGHTED CYCLOPS',
    hp:72000,atk:2125,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:72.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:600,bronze:140,silver:26},
    vicReq:5},
  {id:'desecrated_giant',name:'DESECRATED GIANT',
    hp:74000,atk:2180,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:74,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:11.5,arm:7.5,old:620},
    vicReq:5},
  {id:'moonblood_specter',name:'MOONBLOOD SPECTER',
    hp:76000,atk:2235,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:75.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:640,bronze:150,silver:28},
    vicReq:5},
  {id:'gravesinger',name:'GRAVESINGER',
    hp:78000,atk:2290,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:77,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:12.0,arm:8.0,old:660},
    vicReq:5},
  {id:'blight_behemoth',name:'BLIGHT BEHEMOTH',
    hp:80000,atk:2345,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:78.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:680,bronze:160,silver:30},
    vicReq:5},
  {id:'lich_sovereign',name:'LICH SOVEREIGN',
    hp:80000,atk:2800,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:95,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:20,arm:8,old:1000,bronze:300},
    vicReq:5},
  {id:'ashen_seraph',name:'ASHEN SERAPH',
    hp:88000,atk:3000,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:100,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1200,bronze:380,silver:40},
    vicReq:5},
  {id:'dread_overlord',name:'DREAD OVERLORD',
    hp:96000,atk:3200,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:105,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:22,arm:10,old:1400,bronze:450},
    vicReq:5},
  {id:'plague_archon',name:'PLAGUE ARCHON',
    hp:104000,atk:3400,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:110,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:1600,bronze:520,silver:55,mxd:0.5},
    vicReq:5},
  {id:'voidborn_tyrant',name:'VOIDBORN TYRANT',
    hp:112000,atk:3600,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:115,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:25,arm:12,old:1800,bronze:600},
    vicReq:5},
  {id:'hollow_god_husk',name:'HOLLOW GOD-HUSK',
    hp:120000,atk:3800,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:120,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:2000,bronze:680,silver:70,mxd:0.7},
    vicReq:5},
  {id:'soulweaver_ancient',name:'SOULWEAVER ANCIENT',
    hp:128000,atk:4000,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:128,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:28,arm:14,old:2200,bronze:760},
    vicReq:5},
  {id:'desecrated_archangel',name:'DESECRATED ARCHANGEL',
    hp:136000,atk:4200,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:135,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:2400,bronze:840,silver:85,crc:0.2},
    vicReq:5},
  {id:'bonelord_eternal',name:'BONELORD ETERNAL',
    hp:144000,atk:4400,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:142,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:32,arm:16,old:2600,bronze:920},
    vicReq:5},
  {id:'maelstrom_wraith',name:'MAELSTROM WRAITH',
    hp:152000,atk:4600,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:149,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:2800,bronze:1000,silver:100,mxd:0.9},
    vicReq:5},
  {id:'abyssal_monarch',name:'ABYSSAL MONARCH',
    hp:160000,atk:4800,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:157,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:36,arm:18,old:3000,bronze:1100},
    vicReq:5},
  {id:'gravemind_elder',name:'GRAVEMIND ELDER',
    hp:168000,atk:5000,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:164,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:3200,bronze:1200,silver:120,crc:0.3},
    vicReq:5},
  {id:'bloodbound_colossus',name:'BLOODBOUND COLOSSUS',
    hp:176000,atk:5200,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:171,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:40,arm:20,old:3400,bronze:1300},
    vicReq:5},
  {id:'cursed_demigod',name:'CURSED DEMIGOD',
    hp:184000,atk:5400,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:178,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:3600,bronze:1400,silver:140,mxd:1.2},
    vicReq:5},
  {id:'pale_dominion',name:'PALE DOMINION',
    hp:192000,atk:5600,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:185,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:44,arm:22,old:3800,bronze:1500},
    vicReq:5},
  {id:'hollow_primarch',name:'HOLLOW PRIMARCH',
    hp:200000,atk:5800,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:192,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:4000,bronze:1600,silver:160,crc:0.4},
    vicReq:5},
  {id:'forsaken_titan',name:'FORSAKEN TITAN',
    hp:210000,atk:6000,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:200,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:48,arm:24,old:4200,bronze:1700},
    vicReq:5},
  {id:'sorrow_sovereign',name:'SORROW SOVEREIGN',
    hp:220000,atk:6200,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:207,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:4400,bronze:1800,silver:180,mxd:1.5},
    vicReq:5},
  {id:'shattered_deity',name:'SHATTERED DEITY',
    hp:230000,atk:6500,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:215,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:52,arm:26,old:4700,bronze:1900},
    vicReq:5},
  {id:'ironblight_colossus',name:'IRONBLIGHT COLOSSUS',
    hp:240000,atk:6800,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:222,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:5000,bronze:2000,silver:200,crc:0.5,mxd:1.8},
    vicReq:5},
  {id:'the_devourer',name:'THE DEVOURER',
    hp:260000,atk:8000,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:230,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:80,arm:30,old:8000,bronze:3000,silver:250},
    vicReq:5},
  {id:'nameless_king',name:'NAMELESS KING',
    hp:300000,atk:9333,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:258,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:12000,bronze:4500,silver:350,mxd:2.0,crc:0.6},
    vicReq:5},
  {id:'he_who_unravels',name:'HE WHO UNRAVELS',
    hp:340000,atk:10667,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:285,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:110,arm:40,old:18000,bronze:6500},
    vicReq:5},
  {id:'throne_of_ash',name:'THRONE OF ASH',
    hp:380000,atk:12000,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:313,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:25000,bronze:9000,silver:500,mxd:2.5,crc:0.7},
    vicReq:5},
  {id:'the_pale_hunger',name:'THE PALE HUNGER',
    hp:400000,atk:13333,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:340,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:140,arm:50,old:35000,bronze:12000,silver:600},
    vicReq:5},
  {id:'godrot',name:'GODROT',
    hp:430000,atk:14667,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:368,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:48000,bronze:16000,silver:750,mxd:3.0,crc:0.8},
    vicReq:5},
  {id:'the_unfinished',name:'THE UNFINISHED',
    hp:460000,atk:16000,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:395,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:170,arm:60,old:65000,bronze:22000,silver:900},
    vicReq:5},
  {id:'womb_of_plague',name:'WOMB OF PLAGUE',
    hp:490000,atk:17333,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:423,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:85000,bronze:30000,silver:1100,mxd:3.5,crc:0.9},
    vicReq:5},
  {id:'bleeding_throne',name:'BLEEDING THRONE',
    hp:500000,atk:18667,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:450,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:200,arm:75,old:110000,bronze:40000,silver:1300,mxd:4.0},
    vicReq:5},
  {id:'the_hollow_crown',name:'THE HOLLOW CROWN',
    hp:550000,atk:20000,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:480,mth:0,acc:0,blk:0,bld:0,ctr:0,
...
// ═══════════════════════════════════════════════════════
const SHOP_ITEMS = [
  {id:'Upgrade_HP',  name:'HP Upgrade',   desc:'Increase Maximum health point',   effect:'HP +5%',  cost:{old:1}, statBonus:{hp:0.05},  isPct:true, maxOwned:100},
  {id:'Upgrade_ATK', name:'ATK Upgrade',  desc:'Increase attack power',           effect:'ATK +5%', cost:{old:1}, statBonus:{atk:0.05}, isPct:true, maxOwned:100},
  {id:'Upgrade_MND', name:'MND Upgrade',  desc:'Increase minimal damage',         effect:'MND +1%', cost:{silver:100}, statBonus:{mnd:0.01}, maxOwned:100},
  {id:'Upgrade_MXD', name:'MXD Upgrade',  desc:'Increase maximum damage',         effect:'MXD +1%', cost:{silver:100}, statBonus:{mxd:0.01}, maxOwned:100},
  {id:'Upgrade_SPD', name:'SPD Upgrade',  desc:'Reduce turn time (faster)',        effect:'SPD -10ms', cost:{old:1000}, statBonus:{spd:-10}, maxOwned:100},
  {id:'Upgrade_RGN', name:'RGN Upgrade',  desc:'Increase health regeneration',    effect:'RGN +1%', cost:{old:100}, statBonus:{rgn:0.01}, isPct:true, maxOwned:100},
  {id:'Upgrade_DDC', name:'DDC Upgrade',  desc:'Increase dodge chance',           effect:'DDC +1%', cost:{silver:1}, statBonus:{ddc:0.01}, maxOwned:100},
  {id:'Upgrade_CRC', name:'CRC Upgrade',  desc:'Increase critical rate',          effect:'CRC +2%', cost:{gold:1}, statBonus:{crc:0.01}, maxOwned:100},
  {id:'Upgrade_CRD', name:'CRD Upgrade',  desc:'Increase critical damage',        effect:'CRD +10%', cost:{gold:1}, statBonus:{crd:0.1}, maxOwned:100},
  {id:'Upgrade_ARM', name:'ARM Upgrade',  desc:'Increase armor',                  effect:'ARM +1%', cost:{old:1}, statBonus:{arm:0.01}, isPct:true, maxOwned:100},
  {id:'Upgrade_MTH', name:'MTH Upgrade',  desc:'Increase multi hit chance',       effect:'MTH +1%', cost:{plat:1}, statBonus:{mth:0.01}, maxOwned:100},
  {id:'Upgrade_ACC', name:'ACC Upgrade',  desc:'Increase accuracy',               effect:'ACC +1%', cost:{gold:1}, statBonus:{acc:0.01}, maxOwned:100},
  {id:'Upgrade_BLK', name:'BLK Upgrade',  desc:'Increase block chance',           effect:'BLK +1%', cost:{silver:1}, statBonus:{blk:0.01}, maxOwned:100},
  {id:'Upgrade_BLD', name:'BLD Upgrade',  desc:'Increase block damage reduction', effect:'BLD +1%', cost:{silver:1}, statBonus:{bld:0.01}, isPct:true, maxOwned:100},
  {id:'Upgrade_CTR', name:'CTR Upgrade',  desc:'Increase counter rate',           effect:'CTR +1%', cost:{plat:1}, statBonus:{ctr:0.01}, maxOwned:100},
];