...
const CREATURES = [
  ...
  {id:'ashwalker',name:'ASHWALKER',
    hp:20,atk:4,mnd:0.7,mxd:1.2,spd:3000,rgn:0,ddc:0,crc:0,crd:0,arm:0,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{arm:1,old:1},
    vicReq:5,
    img:'attached_assets/img/creature/3ashwalker.png'},
  {id:'bonepicker',name:'BONEPICKER',
    hp:30,atk:5,mnd:0.7,mxd:1.2,spd:2500,rgn:0,ddc:0,crc:0,crd:0,arm:1,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:1,hp:1,old:1},
    vicReq:5},
  {id:'grave_rat',name:'GRAVE RAT',
    hp:700,atk:6,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.2,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:0.45,old:0.2},
    vicReq:5},
  {id:'mudborn',name:'MUDBORN',
    hp:750,atk:7,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.14,old:0.24},
    vicReq:5},
  {id:'corpse_crawler',name:'CORPSE CRAWLER',
    hp:800,atk:8,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.3,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.26,hp:0.5},
    vicReq:5},
  {id:'rotting_serf',name:'ROTTING SERF',
    hp:850,atk:9,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.15,old:0.28},
    vicReq:5},
  {id:'blighted_husk',name:'BLIGHTED HUSK',
    hp:900,atk:10,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.4,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:0.55,old:0.3},
    vicReq:5},
  {id:'soot_fiend',name:'SOOT FIEND',
    hp:950,atk:11,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.5,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{atk:0.16,old:0.32},
    vicReq:5},
  {id:'wretched_thrall',name:'WRETCHED THRALL',
    hp:1000,atk:13,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{old:0.34,atk:0.14},
    vicReq:5},
  {id:'festering_vagrant',name:'FESTERING VAGRANT',
    hp:1050,atk:14,mnd:0,mxd:0,spd:0,rgn:0,ddc:0,crc:0,crd:0,arm:1.6,mth:0,acc:0,blk:0,bld:0,ctr:0,
    rewards:{hp:0.6,old:0.35},
    vicReq:5},
...
const SHOP_ITEMS = [
  ...
  {id:'Upgrade_MND', name:'MND Upgrade',  desc:'Increase minimal damage',         effect:'MND +1%', cost:{old:1}, statBonus:{mnd:0.01}, maxOwned:100},
  {id:'Upgrade_MXD', name:'MXD Upgrade',  desc:'Increase maximum damage',         effect:'MXD +1%', cost:{old:1}, statBonus:{mxd:0.01}, maxOwned:100},
  {id:'Upgrade_SPD', name:'SPD Upgrade',  desc:'Increase speed',                  effect:'SPD +10', cost:{old:1}, statBonus:{spd:10}, maxOwned:100},
  {id:'Upgrade_RGN', name:'RGN Upgrade',  desc:'Increase health regeneration',    effect:'RGN +1%', cost:{old:1}, statBonus:{rgn:0.01}, isPct:true, maxOwned:100},
  {id:'Upgrade_DDC', name:'DDC Upgrade',  desc:'Increase dodge chance',           effect:'DDC +1%', cost:{old:1}, statBonus:{ddc:0.01}, maxOwned:100},
  {id:'Upgrade_CRC', name:'CRC Upgrade',  desc:'Increase critical rate',          effect:'CRC +1%', cost:{old:1}, statBonus:{crc:0.01}, maxOwned:100},
  {id:'Upgrade_CRD', name:'CRD Upgrade',  desc:'Increase critical damage',        effect:'CRD +1%',cost:{old:1}, statBonus:{crd:0.1}, maxOwned:100},
  {id:'Upgrade_ARM', name:'ARM Upgrade',  desc:'Increase armor',                  effect:'ARM +1%', cost:{old:1}, statBonus:{arm:0.01}, isPct:true, maxOwned:100},
  {id:'Upgrade_MTH', name:'MTH Upgrade',  desc:'Increase multi hit chance',       effect:'MTH +1%', cost:{old:1}, statBonus:{mth:0.01}, maxOwned:100},
  {id:'Upgrade_ACC', name:'ACC Upgrade',  desc:'Increase accuracy',               effect:'ACC +1%', cost:{old:1}, statBonus:{acc:0.01}, maxOwned:100},
  {id:'Upgrade_BLK', name:'BLK Upgrade',  desc:'Increase block chance',           effect:'BLK +1%', cost:{old:1}, statBonus:{blk:0.01}, maxOwned:100},
  {id:'Upgrade_BLD', name:'BLD Upgrade',  desc:'Increase block damage reduction', effect:'BLD +1%', cost:{old:1}, statBonus:{bld:0.01}, isPct:true, maxOwned:100},
  {id:'Upgrade_CTR', name:'CTR Upgrade',  desc:'Increase counter rate',           effect:'CTR +1%', cost:{old:1}, statBonus:{ctr:0.01}, maxOwned:100},
];